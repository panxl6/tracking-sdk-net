...
public static class AfterShipConfiguration
{
    ...
    public static int MaxRetry
    {
        get
        {
            ...
            if (int.TryParse(Environment.GetEnvironmentVariable(SDK_PREFIX + "_MAX_RETRY"), out var n) &&
                n > 0) return n;
    ...
    public static int Timeout
    {
        get
        {
            ...
            if (int.TryParse(Environment.GetEnvironmentVariable(SDK_PREFIX + "_TIMEOUT"), out var n) && n > 0) return n;
    ...
    public static string Proxy
    {
        get
        {
            if (!string.IsNullOrEmpty(proxy)) return proxy;
    ...
    public static string AuthenticationType
    {
        get
        {
            if (!string.IsNullOrEmpty(authenticationType)) return authenticationType;
