...
public class ErrorCode
{
    ...
    public static AfterShipError GenAPIError(int statusCode, int metaCode, string responseBody = null,
        string message = null)
    {
        var errorCode = LocateErrorCode(metaCode);
    ...
    public static AfterShipError GenError(string errorCode, int? statusCode, int? metaCode, string responseBody = null,
        string message = null)
    {
        if (string.IsNullOrEmpty(message)) message = errorMessageMap.GetValueOrDefault(errorCode) ?? "Unknown error";
    ...
    {
        if (errorMap.ContainsKey(metaCode)) return errorMap[metaCode];
