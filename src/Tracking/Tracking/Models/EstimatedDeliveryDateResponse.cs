...
public class EstimatedDeliveryDateResponse
{
    ...
    /// <summary>
    ///     OriginAddress The location from where the package is picked up by the carrier to be delivered to the final
    ///     destination.
    /// </summary>
    ...
    /// <summary>
    ///     PickupTime The local pickup time in the origin address time zone of the package.Either `pickup_time` or
...
{
    /// <summary>
    ///     Country The country/region of the origin location from where the package is picked up by the carrier to be
    ///     delivered to the final destination. Use 3 letters of ISO 3166-1 country/region code.
    /// </summary>
    [JsonProperty("country")]
    public string Country { get; set; }

    /// <summary>
    ///     State State, province, or the equivalent location of the origin address. Use 3 letters of ISO 3166-1 country/region
    ///     code for countries/regions without state. Either `origin_address.state` or `origin_address.postal_code` is
    ///     required.
    /// </summary>
    ...
    /// <summary>
    ///     City City of the origin address. Use 3 letters of ISO 3166-1 country/region code for countries/regions without
    ///     City.
    /// </summary>
    ...
    /// <summary>
    ///     PostalCode Postal code of the origin address. Use 3 letters of ISO 3166-1 country/region code for countries/regions
    ///     without postal code. Either `origin_address.state` or `origin_address.postal_code` is required.
    /// </summary>
    [JsonProperty("postal_code", NullValueHandling = NullValueHandling.Ignore)]
    public string? PostalCode { get; set; }

    /// <summary>
    ///     RawLocation Raw location of the origin address. A raw address will help AI to identify the accurate location of the
    ///     origin address.
    /// </summary>
...
{
    /// <summary>
    ///     Country The country/region of the destination location where the package will be delivered. Use 3 letters of ISO
    ///     3166-1 country code.
    /// </summary>
    [JsonProperty("country")]
    public string Country { get; set; }
    ...
    /// <summary>
    ///     State State, province, or the equivalent location of the destination address where the package will be
    ///     delivered.Either `destination_address.state` or `destination_address.postal_code` is required.
    /// </summary>
    [JsonProperty("state", NullValueHandling = NullValueHandling.Ignore)]
    public string? State { get; set; }
    ...
    /// <summary>
    ///     PostalCode Postal code of the destination address.Either `destination_address.state` or
    ///     `destination_address.postal_code` is required.
    /// </summary>
    [JsonProperty("postal_code", NullValueHandling = NullValueHandling.Ignore)]
    public string? PostalCode { get; set; }

    /// <summary>
    ///     RawLocation Raw location of the destination address. A raw address will help AI to identify the accurate location
...
public class EstimatedPickupEstimatedDeliveryDateResponse
{
    ...
    /// <summary>
    ///     BusinessDays Operating days in a week. Number refers to the weekday.E.g., [1,2,3,4,5] means operating days are from
    ///     Monday to Friday.AfterShip will set [1,2,3,4,5] as the default value.
    /// </summary>
...
{
    /// <summary>
    ///     Unit Processing time of an order, from being placed to being picked up. Only support day as value now.AfterShip
    ///     will set day as the default value.
    /// </summary>
