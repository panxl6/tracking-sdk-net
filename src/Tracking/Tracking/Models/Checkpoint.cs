...
{
    /// <summary>
    ///     CreatedAt The date and time of the checkpoint event was added to AfterShip. It uses the format
    ...
    /// <summary>
    ///     CheckpointTime The date and time of the checkpoint event, provided by the carrier. It uses the timezone of the
    ///     checkpoint. The format may differ depending on how the carrier provides it:- YYYY-MM-DDTHH:mm:ss-
    ...
    /// <summary>
    ///     Coordinate The latitude and longitude coordinates indicate the precise location of the shipments that are currently
    ///     in transit.
    /// </summary>
    ...
    /// <summary>
    ///     Events The array provides details about specific event(s) that occurred  to a shipment, such as
    ///     "returned_to_sender". You can find the full list of events and reasons </span>- The events' value for the same
    ///     checkpoint message is subject to change as we consistently strive to enhance the performance of this feature.
    /// </summary>
