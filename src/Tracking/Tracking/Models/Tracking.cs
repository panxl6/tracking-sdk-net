...
public class Tracking
{
    ...
    /// <summary>
    ///     CreatedAt The date and time the shipment was imported or added to AfterShip. It uses the format
    ///     `YYYY-MM-DDTHH:mm:ssZ` for the timezone GMT +0.
    /// </summary>
    [JsonProperty("created_at", NullValueHandling = NullValueHandling.Ignore)]
    public string? CreatedAt { get; set; }

    /// <summary>
    ///     UpdatedAt The date and time the shipment was updated. It uses the format `YYYY-MM-DDTHH:mm:ssZ` for the timezone
    ///     GMT +0.
    /// </summary>
    ...
    /// <summary>
    ///     LastUpdatedAt (Legacy) The date and time the shipment was updated. It uses the format `YYYY-MM-DDTHH:mm:ssZ` for
    ///     the timezone GMT +0.
    /// </summary>
    ...
    /// <summary>
    ///     Slug Unique courier code. When importing a shipment with no courier slug and the tracking number can’t be
    ///     recognized, the courier will be marked as `unrecognized`. Get courier codes .
    /// </summary>
    ...
    ///     customers, do not include any  in custom fields.
    /// </summary>
    ...
    /// <summary>
    ///     TransitTime Total transit time in days.- For delivered shipments: Transit time (in days) = Delivered date - Pick-up
    ///     date- For undelivered shipments: Transit time (in days) = Current date - Pick-up dateValue as `null` for the
    ///     shipment without pick-up date.
    /// </summary>
    ...
    /// <summary>
    ///     CourierDestinationCountryIso3 Destination country/region of the tracking detected from the courier. ISO Alpha-3
    ///     (three letters). Value will be `null` if the courier doesn't provide the destination country.
    /// </summary>
    ...
    /// <summary>
    ///     ExpectedDelivery The estimated delivery date provided by the carrier. It uses the shipment recipient’s timezone and
    ///     the format may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss-
    ///     YYYY-MM-DDTHH:mm:ssZ
    /// </summary>
    [JsonProperty("expected_delivery", NullValueHandling = NullValueHandling.Ignore)]
    ...
    /// <summary>
    ///     OrderDate The date and time the order was created in your system or store. It uses the format:
    ///     `YYYY-MM-DDTHH:mm:ssZ` based on whichever timezone you provide.
    /// </summary>
    ...
    /// <summary>
    ///     ShipmentPickupDate The date and time the shipment was picked up by the carrier. It uses the timezone where the
    ///     pickup occured. The format may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss-
    ///     YYYY-MM-DDTHH:mm:ssZ
    /// </summary>
    ...
    /// <summary>
    ///     ShipmentDeliveryDate The date and time the shipment was delivered. It uses the shipment recipient’s timezone. The
    ///     format may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ
    /// </summary>
    ...
    /// <summary>
    ///     Smses The phone number(s) to receive sms notifications.  Phone number should begin with `+` and `Area Code` before
    ...
    /// <summary>
    ///     LastMileTrackingSupported Indicates if the shipment is trackable till the final destination.Three possible values:-
    ///     true- false- null
    /// </summary>
    ...
    ///     send the recipient tracking updates in their preferred language.
    /// </summary>
    ...
    /// <summary>
    ///     ReturnToSender Whether or not the shipment is returned to sender. Value is `true` when any of its checkpoints has
    ///     subtag `Exception_010` (returning to sender) or `Exception_011` (returned to sender). Otherwise value is `false`.
    /// </summary>
    ...
    ///     timezone and uses whatever date you provide.
    /// </summary>
    ...
    /// <summary>
    ///     CourierTrackingLink Official tracking URL of the courier (if any). The language parameter of this link relies on
    ///     the destination country/region and the language associated with the shipment, if the data regarding the destination
    ///     country/region and language of the shipment is not available, AfterShip will set the language parameter of the link
    ///     to "US" by default.
    /// </summary>
    ...
    /// <summary>
    ///     FirstAttemptedAt The date and time of the carrier’s first attempt to deliver the package to the recipient.  It uses
    ///     the shipment recipient’s timezone. The format may differ depending on how the carrier provides it:-
    ...
    /// <summary>
    ///     CourierRedirectLink Delivery instructions (delivery date or address) can be modified by visiting the link if
    ///     supported by a carrier. The language parameter of this link relies on the destination country/region and the
    ///     language associated with the shipment, if the data regarding the destination country/region and language of the
    ///     shipment is not available, AfterShip will set the language parameter of the link to "US" by default.
    /// </summary>
    ...
    /// <summary>
    ///     AftershipEstimatedDeliveryDate The estimated delivery date of the shipment provided by AfterShip’s AI and shown to
    ///     the recipients. It uses the format `YYYY-MM-DD` based on the shipment recipient’s timezone.
    /// </summary>
    ...
    /// <summary>
    ///     CustomEstimatedDeliveryDate Estimated delivery time of the shipment based on your . It uses the format `YYYY-MM-DD`
    ...
    /// <summary>
    ///     FirstEstimatedDelivery The shipment’s original estimated delivery date. It could be provided by the carrier,
    ///     AfterShip AI, or based on your custom settings. The format of carrier EDDs may differ depending on how the carrier
    ///     provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ AfterShip AI and custom EDDs always use the
    ///     format `YYYY-MM-DD`. All EDDs use the shipment recipient’s timezone.
    /// </summary>
    ...
    /// <summary>
    ///     LatestEstimatedDelivery The most recently calculated estimated delivery date. It could be provided by the carrier,
    ///     AfterShip AI, or based on your custom settings. The format of carrier EDDs may differ depending on how the carrier
    ///     provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ AfterShip AI and custom EDDs always use the
    ///     format `YYYY-MM-DD`. All EDDs use the shipment recipient’s timezone.
    /// </summary>
    ...
    /// <summary>
    ///     CourierConnectionId If you have multiple accounts connected for a single carrier on AfterShip, we have introduced
    ///     the courier_connection_id field to allow you to specify the carrier account associated with each shipment. By
    ///     providing this information, you enable us to accurately track and monitor your shipments based on the correct
    ///     carrier account.(</br>In the event that you do not specify the courier_connection_id, we will handle your shipment
    ///     using the connection that was created earliest among your connected accounts.
    /// </summary>
    ...
    /// <summary>
    ///     CarbonEmissions The model contains the total amount of carbon emissions generated by the shipment. - AfterShip will
    ///     provide this data only when it is available, and its availability is contingent upon the location and weight
    ///     information that AfterShip can obtain.- The values will be accessible solely for shipments that have been
    ///     successfully delivered. However, in the event of a shipping update after the delivery status has been achieved, the
    ///     value may change.- It’s a paid service and only for Tracking Enterprise users, please contact your customer success
    ///     manager if you want to know more.
    /// </summary>
    ...
    /// <summary>
    ///     FailedDeliveryAttempts By dynamically tracking failed delivery attempts during shipment, this field allows you to
    ///     pinpoint carriers accountable for the most failures. Analyzing the root cause of these failures enables you to
    ///     improve carriers' delivery standard operating procedures (SOP), leading to an overall enhancement in delivery
    ///     service quality.
    /// </summary>
    ...
    /// <summary>
    ///     SignatureRequirement The signature_requirement field serves the purpose of validating the service option type,
    ///     specifically proof of delivery. By collecting the recipient's signature upon delivery, it ensures the package
    ///     reaches the intended recipient and prevents disputes related to non-delivery or lost packages.</br>
    /// </summary>
...
public class AftershipEstimatedDeliveryDateTracking
{
    ...
    /// <summary>
    ///     ConfidenceCode Indicates the confidence level and associated reason for an AI EDD prediction request. For a
    ///     comprehensive list of confidence codes, refer to .
    /// </summary>
