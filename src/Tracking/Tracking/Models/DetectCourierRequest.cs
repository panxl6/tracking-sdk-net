...
public class TrackingDetectCourierRequest
{
    ...
    /// <summary>
    ///     Slug If not specified, Aftership will automatically detect the courier based on the tracking number format and your
    ///     . Use array or comma separated to input a list of couriers for auto detect. Cannot be used with slug_group at the
    ///     same time.
    /// </summary>
    ...
    /// <summary>
    ///     TrackingAccountNumber Account number of the shipper for a specific courier. Required by some couriers. Refer to
    ///     for more details
    /// </summary>
    ...
    /// <summary>
    ///     TrackingDestinationCountry Destination Country/Region of the shipment for a specific courier. Required by some
    ///     couriers. Refer to  for more details
    /// </summary>
