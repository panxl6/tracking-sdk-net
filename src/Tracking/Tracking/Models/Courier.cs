...
public class Courier
{
    ...
    /// <summary>
    ///     RequiredFields The extra fields need for tracking, such as `tracking_account_number`, `tracking_postal_code`,
    ...
    /// <summary>
    ///     OptionalFields The extra fields which are optional for tracking. Basically it's the same as required_fields, but
    ///     the difference is that only some of the tracking numbers require these fields.
    /// </summary>
