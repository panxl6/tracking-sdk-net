...
/// </summary>
public class
    MarkTrackingCompletedBySlugTrackingNumberAdapter : IAdapter<Tracking,
...
///     Tracking adapter for legacy object convert to new model object
/// </summary>
public class DeleteTrackingByIdAdapter : IAdapter<PartialDeleteTracking, DeleteTrackingByIdResponse>
{
...
///     Tracking adapter for legacy object convert to new model object
/// </summary>
public class MarkTrackingCompletedByIdAdapter : IAdapter<Tracking, MarkTrackingCompletedByIdResponse>
{
...
///     Tracking adapter for legacy object convert to new model object
/// </summary>
public class GetTrackingBySlugTrackingNumberAdapter : IAdapter<Tracking, GetTrackingBySlugTrackingNumberResponse>
{
...
/// </summary>
public class GetTrackingsAdapter : IAdapter<GetTrackingsResponseTrackingListData, GetTrackingsResponse>
{
    public GetTrackingsResponseTrackingListData Adapt(GetTrackingsResponse source)
    {
        var data = new GetTrackingsResponseTrackingListData();
...
///     Tracking adapter for legacy object convert to new model object
/// </summary>
public class RetrackTrackingByIdAdapter : IAdapter<PartialUpdateTracking, RetrackTrackingByIdResponse>
{
...
///     Tracking adapter for legacy object convert to new model object
/// </summary>
public class UpdateTrackingBySlugTrackingNumberAdapter : IAdapter<Tracking, UpdateTrackingBySlugTrackingNumberResponse>
{
...
/// </summary>
public class
    DeleteTrackingBySlugTrackingNumberAdapter : IAdapter<PartialDeleteTracking,
...
/// </summary>
public class
    RetrackTrackingBySlugTrackingNumberAdapter : IAdapter<PartialUpdateTracking,
