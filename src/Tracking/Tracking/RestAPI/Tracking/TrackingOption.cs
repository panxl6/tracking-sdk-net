...
public class MarkTrackingCompletedBySlugTrackingNumberOptions : BaseOptions
{
    ...
    public MarkTrackingCompletedBySlugTrackingNumberRequest MarkTrackingCompletedBySlugTrackingNumberRequest
    {
        get;
        set;
    }
...
public class CreateTrackingOptions : BaseOptions
{
    ...
    public override string GetBody()
    {
        ...
        if (CreateTrackingRequest != null) body = BaseResourceService.ToJson(CreateTrackingRequest);
        return body;
    }
}
...
public class UpdateTrackingByIdOptions : BaseOptions
{
    ...
    public override string GetBody()
    {
        ...
        if (UpdateTrackingByIdRequest != null) body = BaseResourceService.ToJson(UpdateTrackingByIdRequest);
        return body;
    }
}